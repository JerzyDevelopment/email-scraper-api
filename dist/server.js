...
var generateCsv_1 = __importDefault(require("./utils/generateCsv"));
var getHtml_1 = __importDefault(require("./utils/getHtml"));
var fs = require("fs");
function listDirectoryContents(path) {
    try {
        ...
        return "Error reading directory ".concat(path, ": ").concat(error.message);
    }
}
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                console.log("Contents of /opt/nodejs/node_modules:", listDirectoryContents("/opt/nodejs/node_modules"));
                url = event === null || event === void 0 ? void 0 : event.url;
                console.log("URL to scrape: " + url);
                return [4 /*yield*/, (0, getHtml_1.default)(url)];
            case 1:
                data = _a.sent();
                return [2 /*return*/, (0, generateCsv_1.default)(data)
